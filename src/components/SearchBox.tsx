...
export default function SearchBox(props: props){
    return(
        <form onSubmit={props.onSubmit} className={cn("flex relative items-center justify-center h-10", props.className)}>
            <input onChange={props.onChange} value={props.value} type="text" placeholder="Search location..." className="px-4 py-4 w-[230px] border border-gray-300 rounded-1-md focus:outline-none focus:border-blue-500 h-full" />
